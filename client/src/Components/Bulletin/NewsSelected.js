			...
			<div className={styles.upperLayout}>
				<Paper elevation={3} className={styles.upperLayoutPaper}>
					<div className={styles.headingConatiner}>
						<Typography variant="h4">news heading</Typography>
					</div>
					<div className={styles.subHeadingConatiner}>
						<Typography variant="h6">news sub heading</Typography>
					</div>
					...
					<div className={styles.sourceContainer}>
						<Typography variant="caption">Source - Source name</Typography>
					</div>
					<div className={styles.publisherContainer}>
						<Typography variant="caption">Published By - Publisher name</Typography>
					</div>
				</Paper>
			</div>
		</div>
